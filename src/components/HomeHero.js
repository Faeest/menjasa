    ...
    return (
      <div className="bg-[url('/images/bg-hero.jpg')] bg-cover bg-no-repeat bg-center">
        <div className="container mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 py-8 text-center lg:text-left md:text-center sm:text-center">
          <h1 className="text-white lg:max-w-2xl font-bold text-xl lg:text-[40px] leading-relaxed mb-2 md:text-[32px] sm:text-[32px]">Discover Your True Potential With TalentFinder - Your Ultimate Platform for Finding The Perfect Job Match</h1>
          ...
          <div className="bg-white p-7 shadow-md rounded-md grid lg:grid-cols-4 gap-3 md:grid-cols-2 sm:grid-cols-1">
            <Stack spacing={3}
            >
              <InputGroup>
              <InputLeftElement
